...
+ Summaries and metadata for each data set (`r b` data sets from `r c` data providers to date);   
...
filt2 <- filt %>%
  ...
  dplyr::mutate(FishCouncilRegion = replace_na(FishCouncilRegion, "International")) %>% 
...
plotname <- 'gomex'
 ...
 North Pacific 
           1946           39449           31895            3887            1650           81606 
        Pacific Western Pacific   International 
...
plotname <- 'south_atlantic'

region <- 'Mid-Atlantic'
plotname <- 'mid_atlantic'

region <- 'New England'
plotname <- 'new_england'

region <- 'North Pacific'
plotname <- 'north_pacific'
...
plotname <- 'international'
 ...
 # theme_bw(base_size = 14, base_family = "ArialMT") + 
  ...
  ggsave(paste("c:/rworking/deepseatools/images/", region, ".png", sep = ''), 
         width = 6.5, 
         height = 5.57, 
         units = "in")
