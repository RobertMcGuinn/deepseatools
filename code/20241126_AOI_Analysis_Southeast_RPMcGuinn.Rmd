...
```{r get_obis_data_in_5000m_buffer, echo=F, eval=T}
...
```{r get_obis_data_in_20000m_buffer, echo=F, eval=T}
##### first transform back to the the original projection back (this is what OBIS and GBIF expect) #####
...
ggplot() +
  # geom_sf(data = oculina, fill = "blue", alpha = 0.3) +
  geom_sf(data = sfaa, fill = "black", alpha = 0.3) +
  # geom_sf(data = sfaa_buf_20000, fill = "black", alpha = 0.3) +
 # geom_sf(data = sfaa_buf_5000, fill = "green", alpha = 0.3) +
 # geom_sf(data = sfaa, fill = "red", alpha = 0.3) +
  # geom_sf(data = obis_sf, 
  #         color = "brown",  # Set fixed color
  #         shape = 2) +
  
   geom_sf(data = obisbuffer5000_sf_filter,
          color = "blue",
          shape = 3,
          alpha = .3, 
          size = 3) +
  ...
  # geom_sf(data = points_in_5000_sel\ect) +
  # geom_sf(data = points_in_20000_select) +
  theme_minimal()
