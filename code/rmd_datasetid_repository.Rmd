...
Go back to data set index page: [LINK](https://deepseacoraldata.noaa.gov/DatasetID_Table/DatasetID_Table_20190418-0.html)
...
```{r, intmap, echo = FALSE, message = FALSE, warning=FALSE, fig.width=5.5, fig.height=4}
...
Records flagged for potential data quality issues (not released to the public): `r length(all$CatalogNumber[all$Flag == "1"])`
