...
key2 <- key1 %>%
  mutate(
    class = case_when(
      DatasetID == "NOAA_RL-19-05" ~ 'Cruise',
      DatasetID == "NOAA_PC2202L1_MDBC" ~ 'Cruise',
      DatasetID == "OET_NA167" ~ 'Cruise',
      DatasetID == "OET_NA163" ~ 'Cruise',
      DatasetID == "OET_NA154" ~ 'Cruise',
      DatasetID == "NOAA_EX-23-06" ~ 'Cruise',
      DatasetID == "NOAA-EX-23-04" ~ 'Cruise',
      DatasetID == "Scripps_BIC" ~ 'Repository',
      DatasetID == "NCPOR" ~ 'Repository',
      TRUE ~ class
    )
  )
