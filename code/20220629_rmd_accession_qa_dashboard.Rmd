...
```{r load_NDB, eval=F, echo=F, message=FALSE, warning=FALSE, cache=FALSE}
...
string <- "C:/rworking/deepseatools/indata/20220425-0_2022-Q2_New_Records_THourigan/20220425-0_2022-Q2_New_Records_THourigan.csv"
sub <- read.csv(string, fileEncoding="latin1", header = T, stringsAsFactors=FALSE)
flagged <- sub %>%  filter(Flag == "1")
```

```{r OR_dOOOOOata_and_subset_gdrive,echo=FALSE, message=FALSE, warning=FALSE, eval=F}
