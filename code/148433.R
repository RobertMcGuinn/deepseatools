...
##### ***** NEW VERSION: 20250811-3_OET_NA156_148433 ***** #####
##### load dataset from CSV #####
setwd('c:/rworking/deepseatools/indata')
filename <- '20250811-3_OET_NA156_148433'
sub <- read.csv(paste(filename, '.csv', sep=''))

##### check #####
# table(sub$ScientificName, useNA = 'always')
# x <- sub %>% filter(is.na(ScientificName) == T)
# table(x$AphiaID)
# table(sub$VerbatimScientificName)
...
##### ***** NEW VERSION: 220250924-0_OET_NA156_148433 ***** #####
##### load dataset from CSV #####
setwd('c:/rworking/deepseatools/indata')
filename <- '20250924-0_OET_NA156_148433'
sub <- read.csv(paste(filename, '.csv', sep=''))
...
folderurl <- "https://drive.google.com/drive/folders/17P0GmNLYfIdtz1LXc0L1y2RJ4Ho3TO2N"
