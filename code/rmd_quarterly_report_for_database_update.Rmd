...
```{r load_both_db, echo=FALSE}

# setwd("C:/rworking/deepseatools/indata")
# indata1<-read.csv("DSCRTP_NatDB_20190920-0.csv", header = T)
# filt1 <- indata1 %>%
#   filter(Flag == "0")
# 
# setwd("C:/rworking/deepseatools/indata")
# indata2<-read.csv("DSCRTP_NatDB_20191217-0.csv", header = T)
# filt2 <- indata2 %>%
#   filter(Flag == "0")
...
quarter <- "Q1, FY-2020"
version <- "DSCRTP_NatDB_20191217-0"
