...
indata1<-read.csv("DSCRTP_NatDB_20191217-0.csv", header = T)
filt1 <- indata1 %>%
  filter(Flag == "0")

setwd("C:/rworking/deepseatools/indata")
indata2<-read.csv("DSCRTP_NatDB_20200408-1.csv", header = T)
filt <- indata2 %>%
  filter(Flag == "0")
# 
# rm(indata1)
...
quarter <- 'Q2, FY-2020'
version <- 'DSCRTP_NatDB_20200408-1'
...
Go here to view and download custom data subsets of voyour choosing:
