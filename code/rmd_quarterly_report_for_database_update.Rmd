...
## [Manual]
quarter <- 'Q4, FY-2021'
version <- 'DSCRTP_NatDB_20211110-0'
...
indata1<-read.csv("DSCRTP_NatDB_20210803-0.csv", header = T)

filt1 <- indata1 %>%
  filter(Flag == "0")
setwd("C:/rworking/deepseatools/indata")

indata2 <- read.csv("DSCRTP_NatDB_20211110-0.csv", header = T) #DSCRTP_NatDB_20210803-0
filt <- indata2 %>%
  filter(Flag == "0")
