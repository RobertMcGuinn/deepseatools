...
cor2019 <- d5 %>% filter(fy == '2019', type == 'corrected') %>% pull(sum3)
orig2019 <- d5 %>% filter(fy == '2019', type == 'totrecords') %>% pull(sum3)
new2019 <- d5 %>% filter(fy == '2019', type == 'newrecords') %>% pull(sum3)
  
cor2018 <- d5 %>% filter(fy == '2018', type == 'corrected') %>% pull(sum3)
orig2018 <- d5 %>% filter(fy == '2018', type == 'totrecords') %>% pull(sum3)
new2018 <- d5 %>% filter(fy == '2018', type == 'newrecords') %>% pull(sum3) 
