...
sub$designation <- 
  case_when(
  sub$CatalogNumber %in% gomex_designation ~ "Inside Designated Area",
  sub$CatalogNumber %notin% gomex_designation ~ "Outside Designated Area"
)
...
sub$fishing_restriction <- 
  ...
  sub$CatalogNumber %notin% gomex_designation_all ~ "Outside of HAPCs"
  )

##### order the levels properly to fit figure requirements #####
sub$fishing_restriction <- factor(sub$fishing_restriction, levels = c('Pre-2016 Fishing-Restricted', '2020 Fishing-Restricted','Outside of HAPCs','Pre-2016 Fishing-Unrestricted', '2020 Fishing-Unrestricted' ))
...
## save the plot
ggsave(paste("c:/rworking/deepseatools/images/", 
             "20201207-0_GOMEX_Fish_Resctriction_by_Depth_SEDCI_", 
             "NatDB_", 
             unique(sub$DatabaseVersion), 
             ".png", 
             sep = ''),
