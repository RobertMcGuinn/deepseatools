...
``` {r CitationMaker, echo = FALSE, eval = F}
...
```{r mapzoomed, echo=FALSE, message = FALSE, warning=FALSE, dpi=300, fig.width=8, fig.height=4.1, eval=FALSE, fig.align='center'}
...
* max: `r max(sub2$IndividualCount)`
