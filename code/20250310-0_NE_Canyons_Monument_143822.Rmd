...
points_for_app <- points %>% dplyr::select(CatalogNumber, RecordType, ScientificName, VernacularNameCategory, Vessel, SurveyID, ObservationDate, PI, DatasetID, DataProvider)
