...
```
\newpage
#### Figure 1 and Table 1: 0-250m
``` {r depth_bin_table_0, echo=FALSE, eval=T}
##### set depth bins #####
i <- 0
mindepth <- i
maxdepth <- i+250
...
```
\newpage
#### Figure 4 and Table 4: 750-1000m
```{r}
##### set depth bins #####
i <- 750
mindepth <- i
...
```
\newpage
#### Figure 5 and Table 5: 1000-1250m
```{r}
##### set depth bins #####
i <- 1000
mindepth <- i
...
```
\newpage
#### Figure 6 and Table 6: 1250-1500m
```{r}
##### set depth bins #####
i <- 1250
mindepth <- i
...
```
\newpage
#### Figure 7 and Table 7: 1500-1750m
```{r}
##### set depth bins #####
i <- 1500
mindepth <- i
...
```
\newpage
#### Figure 8 and Table 8: 1750-2000m
```{r}
##### set depth bins #####
i <- 1750
mindepth <- i
...
```
\newpage
#### Figure 9 and Table 9: 2000-2250m
```{r}
##### set depth bins #####
i <- 2000
mindepth <- i
...
```
\newpage
#### Figure 10 and Table 10: 2250-2500m
```{r}
##### set depth bins #####
i <- 2250
mindepth <- i
...
```
\newpage
#### Figure 11 and Table 11: 2500-2750m
```{r}
##### set depth bins #####
i <- 2500
mindepth <- i
...
```
\newpage
#### Figure 12 and Table 12: 2750-3000m
```{r}
##### set depth bins #####
i <- 2750
mindepth <- i
...
```
\newpage
#### Figure 13 and Table 13: 3000-3250m
```{r}
##### set depth bins #####
i <- 3000
mindepth <- i
...
```
\newpage
#### Figure 14 and Table 14: 3250-3500m
```{r}
##### set depth bins #####
i <- 3250
mindepth <- i
...
```
\newpage
#### Figure 15 and Table 15: 3500-3750m
```{r}
##### set depth bins #####
i <- 3500
mindepth <- i
...
```
\newpage
#### Figure 16 and Table 16: 3750-4500m
```{r}
##### set depth bins #####
i <- 3750
mindepth <- i
