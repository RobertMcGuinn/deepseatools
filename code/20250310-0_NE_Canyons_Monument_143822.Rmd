...
clipped_raster <- mask(cropped_raster, ne_canyons_proj)
...
crm_reclass_7 <- classify(clipped_raster, rcl_matrix)

## write the raster
writeRaster(
  crm_reclass_7,
  filename = "c:/rworking/deepseatools/indata/crm_reclass_7.tif",
