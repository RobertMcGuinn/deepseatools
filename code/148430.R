...
##### manual settings #####
filename <- '148430' ## manual: for this code file name, match to redmine
...
df <- read_tsv('indata/NA168_DARC_Annotations_Full_20250804.tsv')
##### ***** NEW VERSION: 20250811-3_OET_NA168_148430 ***** #####
##### load dataset from CSV #####
setwd('c:/rworking/deepseatools/indata')
filename <- '20250811-3_OET_NA168_148430'
...
##### ***** NEW VERSION: 20250924-0_OET_NA168_148430 ***** #####
##### load dataset from CSV #####
setwd('c:/rworking/deepseatools/indata')
filename <- '20250924-0_OET_NA168_148430'
sub <- read.csv(paste(filename, '.csv', sep=''))
...
folderurl <- "https://drive.google.com/drive/folders/1vwfPdHR5R-y_vJp2pUT5x8CzLNhFvur5"
