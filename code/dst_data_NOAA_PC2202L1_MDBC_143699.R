...
##### ***** NEW Version: 20260408-0 (parameter: change URL) ***** #####
## make sure you clear out the "extracted data" folder first
url <- as_id('https://drive.google.com/file/d/1HBOqUB3_jVmKan77UpHd4MoSzHdxGYJ-/view?usp=drive_link')
file_id <- as_id(url)
...
print(unique(sub$DatasetID))
print(unique(sub$AccessionID))
print(dim(sub))
...
## set parameters
folderurl <- "https://drive.google.com/drive/folders/1kIqyM_KmWRbBXiBbF9dpxHmfp7HOBkSY"
