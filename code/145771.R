...
##### load data #####
setwd('c:/rworking/deepseatools/indata')
filename <- '20250707-0_OET_NA154_145771'
sub <- read.csv(paste(filename, '.csv', sep = ''))
...
sub %>% filter(CategoricalAbundance == '20-nov') %>%
...
folderurl <- "https://drive.google.com/drive/folders/1tqc8sZ3l8-qPn1l5088zpB3pVwpSLkhS"
