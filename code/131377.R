...
## startdate: 20240710
## purpose: see redmine
## redmine title: NOAA_AFSC_GOA_MACE_DropCam_2019_131377
...
sub <- read.csv('../indata/20240711-1_NOAA_AFSC_GOA_MACE_DropCam_2019_131377.csv')
...
sub2 <- sub1 %>%
  mutate(ScientificName2 = case_when(ScientificName %in% "Callogorgia sp." ~ "Callogorgia",
                                     TRUE ~ ScientificName))
...
##### remove Phylum == 'Mollusca' #####
summary <- summary %>% filter(phylum != 'Mollusca')
...
filename <- "20240711-1_NOAA_AFSC_GOA_MACE_DropCam_2019_131377_taxonomy_patch.csv"
