...
## assign TrackingID to SampleID where present
longdf <- longdf %>% mutate(SampleID = ifelse(is.na(TrackingID) == F, TrackingID, SampleID))
...
write.xlsx(longdf, "c:/rworking/deepseatools/indata/20210107_test_file_RPMcGuinn.xlsx", row.names = F)
