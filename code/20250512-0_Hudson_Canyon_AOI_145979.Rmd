...
```{r create_Hudson_aoi, echo=FALSE, echo = F, message = FALSE, warning=FALSE, results = "hide", eval=F }
...
writeVector(aoi_5070_spat, "C:/rworking/deepseatools/indata/hc_aoi_5070.shp", overwrite = TRUE)
...
To create summaries of occurrence data to support decision making in the deep-sea Hudson Canyon region of the Northeastern US.  
