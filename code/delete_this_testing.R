...
##### load the patch  #####
patch <- read.csv('indata/20240110-0_global_taxonomy_patch_NDB_20230828-0_125104.csv')

##### check #####
cats <- c('1108811', '1108812', '1108822', '1108825', '1108833', '1108837', '1108844')
patch %>% filter(CatalogNumber %in% cats) %>% pull(AphiaID)


##### create an edit #####
filtlet <- filt %>%
  filter(VerbatimScientificName == 'Ptilella inflata',
         ScientificName == 'Ptilella grandis')
...
# [1] "Leptogorgia porrecta"          "Pseudothesea pailoloensis"
# [3] "Tribrachium symmetra"          "Atlantisella alenuihaha"
# [5] "Atlantisella alenuihaha"       "Atlantisella alenuihaha"
# [7] "Lepidisis cornucopia"          "Chrysogorgia arbuscula"
# [9] "Halisarca membrana"            "Neopelta aberrans"
# [11] "Acromuricea hirtella"          "Acromuricea alatispina"
# [13] "Acromuricea alatispina"        "Flabellum (Flabellum) oclairi"
